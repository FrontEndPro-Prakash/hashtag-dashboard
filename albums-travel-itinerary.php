...
<div class="wrapper wrapper-content">
    ...
    <div class="page_breadcrumb">
        <p><a href="<?php echo $base_url ?>gems-folder.php">Albums</a><img src="<?php echo $base_url ?>img/arrow-point-to-right.svg">Travel Itinerary</p>
    </div>

    <div class="ibox page_title mb-2">
    ...
    <p class="mb-4">For those who dream of becoming trip-planning experts, here are all the tips and tactics necessary to plan a great travel itinerary.</p>
