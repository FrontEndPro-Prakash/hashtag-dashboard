...
<div class="wrapper wrapper-content">
    ...
    <div class="ibox page_title">
        <div class="ibox-content">
            <h3><img src="<?php echo $base_url ?>/img/gems-folder.svg">Gems Folder</h3>
        </div>
    </div>
        ...
        <form>
            <div class="row align-items-end">
                ...
                <div class="col-md-4 col-7 text-right">
                    <div class="form-group">
                        <a href="<?php echo $base_url ?>add-gem-folder.php" class="btn btn-black">ADD GEM FOLDER</a>
                    </div>
                </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="text-center"><a href="<?php echo $base_url ?>travel-itinerary.php">5</a></td>
                            <td>Active</td>
                            <td>
                                <div class="action_row">
                                    <a class="view_icon" href="<?php echo $base_url ?>travel-itinerary.php"><?php echo $view_icon ?></a>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="<?php echo $base_url ?>travel-itinerary.php">7</a></td>
                            <td>Active</td>
                            <td>
                                <div class="action_row">
                                    <a class="view_icon" href="<?php echo $base_url ?>travel-itinerary.php"><?php echo $view_icon ?></a>
                        ...
                        <tr>
                            ...
                            <td>General</td>
                            <td>Trends 2020</td>
                            <td class="text-center"><a href="<?php echo $base_url ?>travel-itinerary.php">12</a></td>
                            <td>Active</td>
                            <td>
                                <div class="action_row">
                                    <a class="view_icon" href="<?php echo $base_url ?>travel-itinerary.php"><?php echo $view_icon ?></a>
                        ...
                        <tr>
                            ...
                            <td class="text-center"><a href="<?php echo $base_url ?>travel-itinerary.php">13</a></td>
                            <td>Active</td>
                            <td>
                                <div class="action_row">
                                    <a class="view_icon" href="<?php echo $base_url ?>travel-itinerary.php"><?php echo $view_icon ?></a>
                        ...
                        <tr>
                            ...
                            <td>General</td>
                            <td>Tips & Tricks</td>
                            <td class="text-center"><a href="<?php echo $base_url ?>travel-itinerary.php">22</a></td>
                            <td>Active</td>
                            <td>
                                <div class="action_row">
                                    <a class="view_icon" href="<?php echo $base_url ?>travel-itinerary.php"><?php echo $view_icon ?></a>
                        ...
                        <tr>
                            ...
                            <td>Influencer</td>
                            <td>Lounges</td>
                            <td class="text-center"><a href="<?php echo $base_url ?>travel-itinerary.php">67</a></td>
                            <td>Active</td>
                            <td>
                                <div class="action_row">
                                    <a class="view_icon" href="<?php echo $base_url ?>travel-itinerary.php"><?php echo $view_icon ?></a>
                        ...
                        <tr>
                            ...
                            <td>General</td>
                            <td>Lifestyle</td>
                            <td class="text-center"><a href="<?php echo $base_url ?>travel-itinerary.php">78</a></td>
                            <td>Active</td>
                            <td>
                                <div class="action_row">
                                    <a class="view_icon" href="<?php echo $base_url ?>travel-itinerary.php"><?php echo $view_icon ?></a>
